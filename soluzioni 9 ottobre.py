...
def check_date(d, m, y):
    # Disclaimer: C'è un modo più compatto di scrivere
    # questo esercizio, ma non avete ancora visto "and" 
    # e "or", ne' le liste
    if d > 31:
        return False
    if d <= 0:
...
# Usare solo costrutti del linguaggio e non librerie.
# str.replace() cambia tutte le occorrenze della sringa find con la stringa replace
